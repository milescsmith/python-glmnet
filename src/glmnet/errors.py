...
def _fatal_errors(jerr):
    match jerr:
        ...
        case 90000:
            ...
            raise ValueError(msg)
        case _ if jerr < 7777:  # noqa: PLR2004
            msg = f"Memory allocation error (glmnet error no. {jerr})."
            raise RuntimeError(msg)
        case _ if jerr > 8000 and jerr < 9000:  # noqa: PLR2004
            k = jerr - 8000
            msg = f"Probability for class {k} close to 0."
            raise ValueError(msg)
        case _ if jerr > 9000:  # noqa: PLR2004
            k = jerr - 9000
...
def _convergence_errors(jerr):
    match jerr:
        ...
        case jerr if jerr > -10000:  # noqa: PLR2004
            warnings.warn(
