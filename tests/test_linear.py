...
class TestElasticNet(unittest.TestCase):
    def setUp(self):
        ...
        x_wide, y_wide = make_regression(n_samples=100, n_features=150, random_state=1105)
    ...
    def check_r2_score(self, y_true, y, at_least, **other_params):
        ...
        msg = f"expected r2 of {at_least}, got: {score}, with: {other_params}"
...
@pytest.parametrize_with_checks([ElasticNet()])
